...
#define BLURX_DELAY 		440 MILLI_SEC
#define BLURY_DELAY 		625 MILLI_SEC
#define DERI_XY_DELAY 		260 MILLI_SEC
#define MAG_XY_DELAY 		170 MILLI_SEC
#define NMS_DELAY 		290 MILLI_SEC
#define APPLY_HYST_DELAY 	295 MILLI_SEC
...
behavior Non_Max_Supp(in simg gradx, in simg grady, in simg mag, out img nms, out simg magnitude2)
{
	...
	*******************************************************************************/
	void non_max_supp(int nrows, int ncols, unsigned char *result)
	{
	    ...
	    short m00,gx,gy;
	    int mag1,mag2,xperp,yperp; // CHANGED: float -> int
